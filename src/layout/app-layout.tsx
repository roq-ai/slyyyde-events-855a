...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['event-organizer', 'event-manager'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Promotions', path: '/promotions', entity: 'promotion', service: AccessServiceEnum.PROJECT, icon: FiGift },
    {
      name: 'Registrations',
      path: '/registrations',
      entity: 'registration',
    ...
    { name: 'Sessions', path: '/sessions', entity: 'session', service: AccessServiceEnum.PROJECT, icon: FiClock },
    { name: 'Venues', path: '/venues', entity: 'venue', service: AccessServiceEnum.PROJECT, icon: FiMapPin },

...
import { getCheckInById } from 'apiSdk/check-ins';
import { CheckInInterface } from 'interfaces/check-in';

function CheckInViewPage() {
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('check_in', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/check-ins/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                <FormListItem label="Checked In" text={data?.checked_in} />
                ...
                {hasAccess('registration', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                  <FormListItem
                    label="Registration"
                    text={
                      <Link as={NextLink} href={`/registrations/view/${data?.registration?.id}`}>
                        {data?.registration?.attendee_name}
                      </Link>
                    }
                  />
                )}

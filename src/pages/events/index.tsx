  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('promotion', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          ...
          cell: ({ row: { original: record } }: any) => record?._count?.promotion,
        }
      : null,
    ...
    hasAccess('session', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          ...
          header: 'Session',
          accessorKey: 'session',
          cell: ({ row: { original: record } }: any) => record?._count?.session,
        }
      : null,
    hasAccess('venue', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          ...
          header: 'Venue',
          accessorKey: 'venue',
          cell: ({ row: { original: record } }: any) => record?._count?.venue,
        }
      : null,
